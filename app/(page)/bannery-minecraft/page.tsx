...
//   title: 'Freshly.pl - Bannery Minecraft',
// };
    ...
    <main className="relative flex flex-col min-h-screen bg-top bg-no-repeat" style={{ backgroundImage: "url('/pattern.png')" }}>
      ...
      <div className="container mx-auto px-4 pt-[144px] pb-16 flex-grow">
        <div className="flex flex-col items-center gap-4 md:gap-8">
          {/* 
            Tutaj wstaw swoje długie zdjęcie.
            Zachowa ono pełną szerokość i swoją naturalną wysokość.
          */}
          <img
            src="/bannery-minecraft/1.svg" // Zmień na ścieżkę do nowego zdjęcia
            alt="Nowy projekt"
            className="w-full max-w-[1320px] shadow-lg rounded-2xl"
          />
        </div>
      </div>
      <Footer />
